<div id="whatsappForm" class="fixed bottom-40 right-4 w-[95%] lg:w-[400px] bg-white rounded-lg shadow-lg hidden">
  ...
  <div>
    <form class="space-y-3">
      <div class="bg-[#E9E4DE] p-4 py-8 space-y-2 text-right">
        <div class="flex items-center lg:space-x-2">
          <label class="block text-sm font-semibold lg:min-w-[80px]">Nome:</label>
          <input type="text" placeholder="Digite o seu nome" class="flex-1 rounded-lg border px-2 py-3 bg-white">
        </div>
        <div class="flex items-center lg:space-x-2 text-right">
          <label class="block text-sm font-semibold lg:min-w-[80px]">WhatsApp:</label>
          <input type="tel" placeholder="(00) 00000-0000" class="flex-1 rounded-lg border px-2 py-3 bg-white">
        </div>
        <div class="flex items-center lg:space-x-2 text-right">
          <label class="block text-sm font-semibold lg:min-w-[80px]">E-mail:</label>
    ...
    <div>
    <img src="/wp-content/uploads/2025/07/h-widget-whatsapp.webp" alt="" class="fixed bottom-8 right-8 w-[70px] cursor-pointer" id="openWhatsappForm">
  </div>
